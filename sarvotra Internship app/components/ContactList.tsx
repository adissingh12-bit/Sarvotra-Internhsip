    ...
    <div className="w-full">
      ...
      <div className="flex space-x-4 overflow-x-auto pb-2 scrollbar-hide">
        ...
        {contacts.map((contact) => (
          <div key={contact.id} className="flex flex-col items-center space-y-2 min-w-[70px] cursor-pointer group">
            <div className="relative">
              <img 
                src={contact.avatar} 
                alt={contact.name} 
                className="w-14 h-14 rounded-full object-cover border-2 border-transparent group-hover:border-indigo-500 transition-all shadow-sm"
              />
